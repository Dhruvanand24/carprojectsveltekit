...
<main>
  <div
    class="flex flex-col w-full h-screen justify-center items-center bg-[#9f9f9e]"
  >
    <div
      class="flex flex-col p-8 h-[80vh] shadow-md w-[80vw] lg:w-[60vw] bg-white rounded-xl"
    >
      <div class="flex mb-2">
        <div
        ...
        >
          <h1 class="text-white font-bold ml-4 text-xl">User</h1>
        </div>
        <div
        ...
        >
          <h1 class="font-bold text-xl ml-4 text-white">Dealer</h1>
        </div>
      </div>
      <div
        class={`flex transition-all duration-300 ease-linear flex-col h-full ${
          selectedOption === "user" ? "bg-[#e52165]" : "bg-[#0d1137]"
        } rounded-xl`}
      >
